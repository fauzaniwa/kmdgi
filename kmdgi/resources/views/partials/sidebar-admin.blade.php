<aside class="hidden lg:flex flex-col w-full lg:w-[280px] flex-shrink-0 bg-white">
    <div class="px-2 py-4 space-y-1 font-sans">
        ...
        <a href="{{ route('admin.event.index') }}" class="flex items-center gap-4 py-3 px-4 rounded-2xl text-slate-800 hover:text-kmdgi-primary transition-all">
            <svg class="w-6 h-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="{{ route('admin.penampil.index') }}" class="flex items-center gap-4 py-3 px-4 rounded-2xl text-slate-800 hover:text-kmdgi-primary transition-all">
            <svg class="w-6 h-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
