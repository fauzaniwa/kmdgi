...
<aside class="hidden lg:flex flex-col w-full lg:w-[260px] flex-shrink-0 bg-white">
    ...
    <div class="px-2 space-y-1 font-sans">
        ...
        <!-- MENU STATUS PERLOMBAAN SAYA (Semua User / Pendaftar) -->
        <a href="{{ route('peserta.status-lomba') }}" class="flex items-center gap-4 py-3 px-4 rounded-2xl transition-all duration-200 {{ Route::is('peserta.status-lomba') ? 'text-kmdgi-primary bg-kmdgi-primary/5' : 'text-slate-800 hover:text-kmdgi-primary' }}">
            ...
            <span class="font-medium text-[15px]">Status Perlombaan</span>
        </a>
        ...
        <div class="w-full">
            ...
            <div class="pl-[3.5rem] pr-4 py-1 flex flex-col space-y-1 {{ Route::is('delegasi.submisi.*') ? '' : 'hidden' }} submenu-list">
                ...
                <a href="{{ route('delegasi.submisi.karya') }}" class="block px-4 py-2.5 text-sm font-medium {{ Route::is('delegasi.submisi.karya') ? 'bg-kmdgi-primary text-white rounded-xl text-center shadow-sm' : 'text-slate-600 hover:text-kmdgi-primary text-left' }} transition-colors">Konten Delegasi Kampus</a>
