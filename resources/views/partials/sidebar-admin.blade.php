<aside class="hidden lg:flex flex-col w-full lg:w-[280px] flex-shrink-0 bg-white">
    <div class="px-2 py-4 space-y-1 font-sans">
        ...
        <a href="{{ $dashRoute }}" class="flex items-center gap-4 py-3 px-4 rounded-2xl transition-all duration-200 {{ Route::is('superadmin.dashboard', 'admin.dashboard', 'editor.dashboard') ? 'text-kmdgi-primary bg-kmdgi-primary/5' : 'text-slate-800 hover:text-kmdgi-primary' }}">
        ...
        <a href="{{ route('admin.scan-qr.index') }}" class="flex items-center gap-4 py-3 px-4 rounded-2xl transition-all duration-200 {{ Route::is('admin.scan-qr.*') ? 'text-kmdgi-primary bg-kmdgi-primary/5' : 'text-slate-800 hover:text-kmdgi-primary' }}">
            <svg class="w-6 h-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <!-- MENU BARU: REKAP KEHADIRAN (HASIL SCAN) -->
        <div class="w-full">
            <button class="w-full flex items-center justify-between py-3 px-4 {{ Route::is('admin.kehadiran.event.*', 'admin.kehadiran.performance.*', 'admin.kehadiran.pameran.*') ? 'text-kmdgi-primary' : 'text-slate-800' }} hover:text-kmdgi-primary transition-all admin-dropdown-toggle">
                <div class="flex items-center gap-4">
                    <svg class="w-6 h-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <svg class="w-5 h-5 transition-transform duration-200 arrow {{ Route::is('admin.kehadiran.event.*', 'admin.kehadiran.performance.*', 'admin.kehadiran.pameran.*') ? 'rotate-180' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
            </button>
            <div class="pl-[3.5rem] pr-4 py-2 flex flex-col space-y-1 {{ Route::is('admin.kehadiran.event.*', 'admin.kehadiran.performance.*', 'admin.kehadiran.pameran.*') ? '' : 'hidden' }} dropdown-container">
                <a href="{{ route('admin.kehadiran.event.index') ?? '#' }}" class="block px-4 py-2.5 text-sm font-medium {{ Route::is('admin.kehadiran.event.*') ? 'bg-kmdgi-primary text-white rounded-xl text-center shadow-sm' : 'text-slate-600 hover:text-kmdgi-primary text-left' }} transition-colors">Kehadiran Acara / Event</a>
                <a href="{{ route('admin.kehadiran.performance.index') ?? '#' }}" class="block px-4 py-2.5 text-sm font-medium {{ Route::is('admin.kehadiran.performance.*') ? 'bg-kmdgi-primary text-white rounded-xl text-center shadow-sm' : 'text-slate-600 hover:text-kmdgi-primary text-left' }} transition-colors">Kehadiran Performance</a>
                <a href="{{ route('admin.kehadiran.pameran.index') ?? '#' }}" class="block px-4 py-2.5 text-sm font-medium {{ Route::is('admin.kehadiran.pameran.*') ? 'bg-kmdgi-primary text-white rounded-xl text-center shadow-sm' : 'text-slate-600 hover:text-kmdgi-primary text-left' }} transition-colors">Kehadiran Pameran</a>
            </div>
        </div>
        ...
        <div class="w-full">
            <button class="w-full flex items-center justify-between py-3 px-4 {{ Route::is('admin.about.*', 'admin.sejarah.*', 'admin.edisi.*', 'admin.karya.*') && !request()->is('admin/verifikasi-karya*') && !request()->is('*/karya/*') ? 'text-kmdgi-primary' : 'text-slate-800' }} hover:text-kmdgi-primary transition-all admin-dropdown-toggle">
                <div class="flex items-center gap-4">
                    <svg class="w-6 h-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <svg class="w-5 h-5 transition-transform duration-200 arrow {{ Route::is('admin.about.*', 'admin.sejarah.*', 'admin.edisi.*', 'admin.karya.*') && !request()->is('admin/verifikasi-karya*') && !request()->is('*/karya/*') ? 'rotate-180' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
            </button>
            <div class="pl-[3.5rem] pr-4 py-2 flex flex-col space-y-1 {{ Route::is('admin.about.*', 'admin.sejarah.*', 'admin.edisi.*', 'admin.karya.*') && !request()->is('admin/verifikasi-karya*') && !request()->is('*/karya/*') ? '' : 'hidden' }} dropdown-container">
