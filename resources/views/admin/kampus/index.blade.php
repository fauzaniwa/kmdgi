                                ...
                                <td class="py-4 px-6 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <button type="button"
                                            ...
                                            title="Edit Kampus"
                                            class="p-2 text-slate-400 hover:text-kmdgi-primary bg-slate-50 hover:bg-blue-50 rounded-xl transition-colors">
                                            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
<script>
    ...
    function openKampusModal(action, elementOrData = null) {
        ...
        if (action === 'create') {
        ...
        } else if (action === 'edit' && elementOrData) {
            // Ambil data dari atribut HTML data-kampus jika dipanggil via element button
            let data = (elementOrData instanceof HTMLElement) ?
                JSON.parse(elementOrData.getAttribute('data-kampus')) :
                elementOrData;
            ...
            // Menyesuaikan Dropdown Status per Edisi
            if (data.riwayat_status) {
                let riwayat = (typeof data.riwayat_status === 'string') ?
                    JSON.parse(data.riwayat_status) :
                    data.riwayat_status;
